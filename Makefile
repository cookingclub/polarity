...
CFLAGS = -pthread -g -O2 -Wno-warn-absolute-paths -I $(CURDIR) -I$(CURDIR)/libs/box2d/Box2D/ -I$(CURDIR)/libs/libtmx-parser/libs/tinyxml2 -I$(CURDIR)/libs/libtmx-parser/libs/tinyxml2
